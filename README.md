...
<pre>
<span>git clone https://github.com/irboy/tabchiv1.git </span>
...
<br>سازنده و توسعه دهنده : ♚ iranb0y ♚ <a href="https://telegram.me/iranb0y"> @iranb0y </a><br>راهنمای استفاده از تبلیغ‌گر بسیار ساده و قابل درک است<br>فیلم آموزشی نصب و اطلاع از آخرین اخبار تبلیغ‌گر در کانال ما 
